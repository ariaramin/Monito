...
import 'package:monito/app/modules/transaction/controllers/card_picker_controller.dart';
import 'package:monito/app/modules/transaction/controllers/category_picker_controller.dart';
...
class AddTransactionController extends GetxController
  ...
  Rx<Jalali?> selectedDate = Rx<Jalali?>(null);
    ...
    if (formKey.currentState!.validate()) {
      ...
      try {
        ...
        Get.dialog(StatusDialog(
          message: 'add_transaction_success'.tr,
        ...
        Failure(message: 'add_transaction_error'.tr).showDialog();
      } finally {
